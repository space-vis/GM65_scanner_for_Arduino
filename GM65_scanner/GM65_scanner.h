...
extern const uint8_t set_default[9]; //出厂设置
extern const uint8_t set_serial_output[9]; //设置串口输出信息
extern const uint8_t enable_setttingcode[9];
extern const uint8_t disable_setttingcode[9];

extern const uint8_t scan_once_command[9];
