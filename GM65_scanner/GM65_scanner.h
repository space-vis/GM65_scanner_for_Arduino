...
*/
#ifndef CM65_SCANNER_H
#define CM65_SCANNER_H

#include "Arduino.h"
#include "Stream.h"

extern const uint8_t set_default[9] = {0x7E, 0x00, 0x08, 0x01, 0x00, 0xD9, 0x55, 0xAB, 0xCD}; //出厂设置
extern const uint8_t set_serial_output[9] = {0x7E, 0x00, 0x08, 0x01, 0x00, 0x0D, 0x00, 0xAB, 0xCD}; //设置串口输出信息
extern const uint8_t enable_setttingcode[9] = {0x7E, 0x00, 0x08, 0x01, 0x00, 0x03, 0x01, 0xAB, 0xCD};
extern const uint8_t disable_setttingcode[9] = {0x7E, 0x00, 0x08, 0x01, 0x00, 0x03, 0x03, 0xAB, 0xCD};

extern const uint8_t scan_once_command[9] = {0x7E, 0x00, 0x08, 0x01, 0x00, 0x02, 0x01, 0xAB, 0xCD};


class GM65_scanner {
  uint8_t read_reg[9] = {0x7E, 0x00, 0x07, 0x01, 0x00, 0x00, 0x01, 0xAB, 0xCD};
